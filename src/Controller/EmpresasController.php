...
class EmpresasController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['LogLocalidade', 'Empresas'],
        ];
    ...
    public function view($id = null)
    {
        $empresa = $this->Empresas->get($id, [
            'contain' => ['LogLocalidade', 'Empresas', 'Agendamentos', 'CincoEsses', 'Colaboradores', 'EmpresaConfigs', 'EmpresaLocais', 'Financeiro', 'Usuarios'],
        ]);
    ...
    public function add()
    {
        ...
        $logLocalidade = $this->Empresas->LogLocalidade->find('list', ['limit' => 200])->all();
        $empresas = $this->Empresas->Empresas->find('list', ['limit' => 200])->all();
        $this->set(compact('empresa', 'logLocalidade', 'empresas'));
    }
